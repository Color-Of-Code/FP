...
This is the generalisation of [8. Fold](./08-fold.md) from lists to arbitrary recursive types, and
directly builds on [4. Algebraic Data Types](./04-adt.md) and [6. Functor](./06-functor.md).
