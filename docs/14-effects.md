...
Each monad from [12. Monad](./12-monad.md) models exactly one effect.
[13. Monad Transformers](./13-transformer.md) explores the primary solution in depth; this chapter
