...
| 5 | [Fold](docs/05-fold.md) | Reducing a collection to a value; `map`, `filter` and more as folds |
| 6 | [Monad](docs/06-monad.md) | Sequencing effectful computations; solving the `fmap` nesting problem |

## Diagrams

The `basics/` folder contains [D2](https://d2lang.com) source files for each concept diagram.
